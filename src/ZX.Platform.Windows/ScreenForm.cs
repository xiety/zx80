...
public partial class ScreenForm : Form
{
    ...
    private readonly Bitmap screen = new(256, 192, PixelFormat.Format24bppRgb);
    ...
    public ScreenForm()
    {
        ...
        pictureScreen.Image = screen;

        Disposed += (s, e) => screen.Dispose();
    }
    ...
    private void GenerateImages()
    {
        ...
        pictureScreen.Invoke(() =>
        {
            ...
            var data = screen.LockBits(rect, ImageLockMode.WriteOnly, screen.PixelFormat);

            Marshal.Copy(buffer, 0, data.Scan0, buffer.Length);

            screen.UnlockBits(data);
            pictureScreen.Refresh();
        });
    }
